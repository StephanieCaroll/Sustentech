...
const Footer = () => {
  ...
  const handleComplaintSubmit = (e: React.FormEvent) => {
    ...
    console.log("Reclamação enviada:", complaintData);
    ...
    setComplaintData({ type: "", email: "", subject: "", description: "" });
  };
        ...
        <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-lg font-semibold mb-4">SustenTech</h3>
              <p className="text-sm text-muted-foreground mb-4">
                Conectando pessoas para um consumo mais consciente e sustentável. 
                Promovemos a reutilização, reparo e compartilhamento de recursos.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">Como funciona</a></li>
                <li><a href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">Perguntas frequentes</a></li>
                <li><a href="#" className="text-sm text-muted-foreground hover:text-primary transition-colors">Diretrizes da comunidade</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-sm text-muted-foreground">suporte@sustentech.com</li>
                <li className="text-sm text-muted-foreground">+55 (11) 99456-7191</li>
                <li>
                  <Dialog open={isComplaintOpen} onOpenChange={setIsComplaintOpen}>
                    ...
                    <DialogContent>
                      <DialogHeader>
                        <DialogTitle>Envie sua reclamação ou sugestão</DialogTitle>
                      </DialogHeader>
                      <form onSubmit={handleComplaintSubmit} className="space-y-4 mt-4">
                        ...
                        <Textarea 
                          placeholder="Descreva sua reclamação ou sugestão" 
                          rows={5}
          ...
          <div className="border-t border-muted mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">
              © 2023 SustenTech. Todos os direitos reservados.
            </p>
